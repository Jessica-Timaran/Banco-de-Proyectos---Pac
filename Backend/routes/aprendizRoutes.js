...
router.post('/reset-password', async (req, res) => {
  ...
  try {
      ...
      const resetLink = `https://bancodeproyectospac.netlify.app/bancodeproyectospac.netlify.app/Principal/UpdatePassword?token=${resetToken}&email=${encodeURIComponent(email)}`;
