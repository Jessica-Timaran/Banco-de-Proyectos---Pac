...
router.post('/reset-password', async (req, res) => {
  ...
  try {
      ...
      const resetLink = `https://67058969066fc300086b5423--bancodeproyectospac.netlify.app/Principal/UpdatePassword?token=${resetToken}&email=${encodeURIComponent(email)}`;
