...
router.post('/reset-password', async (req, res) => {
  ...
  try {
      ...
      const resetLink = `https://67066fbcc13f7e0008e8dd07--bancodeproyectospac.netlify.app/Principal/UpdatePassword?token=${resetToken}&email=${encodeURIComponent(email)}`;
