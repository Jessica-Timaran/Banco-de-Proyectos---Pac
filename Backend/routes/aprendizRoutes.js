...
router.post('/reset-password', async (req, res) => {
  ...
  try {
      ...
      const resetLink = `https://6705ef0148f7da0008cc5e73--bancodeproyectospac.netlify.app/Principal/UpdatePassword?token=${resetToken}&email=${encodeURIComponent(email)}`;
