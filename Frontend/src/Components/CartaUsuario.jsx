...
const CartaUsuario = ({ Text }) => {
  return (
    <div className="w-full sm:w-5/6 md:w-80 h-auto sm:h-60 bg-[#FBFCFF] rounded-xl border-2 border-[#FBFCFF] shadow-lg flex flex-col items-center justify-center p-4 sm:p-8 mb-4 sm:m-8  hover:border-[#2eb694] transition duration-300 cursor-pointer">
      ...
      <button className="group cursor-pointer outline-none hover:rotate-90 duration-300">
        <svg
          className="stroke-[#2eb694] fill-none group-active:duration-0 duration-300"
          viewBox="0 0 24 24"
          height="60px"
          width="60px"
