  ...
  return (
    ...
    <button
      className={`boton-principal relative cursor-pointer font-semibold overflow-hidden z-10 border border-[#A3E784] group 
        w-[150px] sm:w-[175px] h-[44px] py-[10px] rounded-[5px] mt-3 self-center  ${className} ${isSelected ? 'bg-[#A3E784]' : ''}`}
      onClick={onClick}
    >
      <span className="relative z-10 text-black group-hover:text-black text-[16px] sm:text-[18px] duration-500">
        {Text}
      </span>
