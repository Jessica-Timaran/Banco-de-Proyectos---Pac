...
const VistaAdmin = () => {
  ...
  // Si no está cargando, renderiza el contenido dentro del layout con animación
  return (
    <LayoutHome title="">
      <motion.div
        id="content"
        ...
        animate="visible"
        exit="exit"
        variants={pageVariants} // Aplica las variantes de la animación
        className=""
      >
          ...
          <div className="w-full max-w-7xl flex-grow px-4 sm:px-8 md:px-0">
            <div className="flex flex-col md:flex-row items-start">
              <div className="w-full md:w-1/2 p-4 md:p-8">
                ...
                <span className="text-3xl sm:text-5xl md:text-8xl text-[#2eb694] font-inter mb-4 block">Instructor</span>
